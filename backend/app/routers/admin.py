...
from schemas.admin import AdminSchema, AdminBase
from controllers.admin import create_admin, read_admins
...
async def read_admins_route(skip: int = 0, limit: int = 10, db: Session = Depends(get_db)):
