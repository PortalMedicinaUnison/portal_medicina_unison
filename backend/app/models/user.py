...
class UserEnrollment(BaseModel):
    ...
    __table_args__ = (Index('idx_user_enrollment_academic_id', 'academic_id'),)
...
class User(BaseModel):
    ...
    academic_id: Mapped[str] = mapped_column(String(9), ForeignKey("user_enrollments.academic_id", ondelete="CASCADE"), unique=True, nullable=False)
