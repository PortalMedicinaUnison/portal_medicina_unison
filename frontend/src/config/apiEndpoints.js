export const API_ENDPOINTS = {
  ...
  INTERNSHIPS: {
    ...
    GET_BY_STUDENT: (studentId) => `/internships/studentId/${studentId}`,
  ...
  INTERNSHIP_APPLICATIONS: {
    ...
    GET_BY_STUDENT: (studentId) => `/internship-applications/studentId/${studentId}`,
  ...
  REPORTS: {
    ...
    GET_ALL: '/reports',
    GET: (id) => `/reports/${id}`,
    GET_BY_STUDENT: (studentId) => `/reports/studentId/${studentId}`,
